...
Func iniciar()
				  ...
				  $cidEdit = GUICtrlCreateEdit("", 0, 0, 800, 561, BitOR($ES_AUTOVSCROLL, $ES_READONLY, $WS_HSCROLL, $WS_VSCROLL))
					 ...
					 GUICtrlSetBkColor(-1, 0x000000)
						...
						$pid = run('plink -ssh -P ' & $credencial_porta & ' -t -pw ' & $credencial_senha & ' ' & $credencial_usuario & '@'&$credencial_ip & ' -R :34'& $porta_aleatoria &':127.0.0.1:35963 ' & "bash -l -c 'vicc -vvvvv --type relay --hostname localhost --port 34" & $porta_aleatoria & "'", @ScriptDir, @SW_HIDE,$STDIN_CHILD + $STDERR_MERGED)
